...
<section class="ws-section">
    ...
    <article class="ws-page-content">
        ...
        <section class="ws-cta-box">
            <h2>Inizia ora</h2>
            <p>
                <a class="ws-btn ws-btn--primary" href="https://wa.me/<?php echo esc_attr(preg_replace('/[^0-9]/', '', (string) get_option('wecoop_whatsapp_number', '393341390175'))); ?>?text=<?php echo esc_attr(rawurlencode((string) get_option('wecoop_whatsapp_message', 'Ciao WECOOP, vorrei iniziare il mio percorso.'))); ?>" target="_blank" rel="noopener">Inizia il tuo percorso</a>
                <a class="ws-btn ws-btn--ghost" href="<?php echo esc_url(home_url('/contact/')); ?>">Parla con un operatore</a>
            </p>
