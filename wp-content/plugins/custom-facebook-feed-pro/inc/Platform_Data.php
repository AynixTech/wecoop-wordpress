...
class Platform_Data
{
	...
	public function handle_platform_data_on_api_response($response, $url)
	{
		...
		\cff_main_pro()->cff_error_reporter->remove_error('platform_data_deleted');
	...
	public function handle_app_permission_error()
	{
		...
		$this->cleanup_revoked_account($cff_statuses_option);
		\cff_main_pro()->cff_error_reporter->reset_api_errors();
		\cff_main_pro()->cff_error_reporter->add_error(
	...
	protected function delete_platform_data($to_delete_connected_account)
	{
		...
		$to_delete_connected_account = (array) $to_delete_connected_account;
	...
	public function handle_unused_feed_usage()
	{
		...
		\cff_main_pro()->cff_error_reporter->remove_error('unused_feed');
