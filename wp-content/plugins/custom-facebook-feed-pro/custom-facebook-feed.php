...
update_option( 'cff_license_key', '********************************' ); update_option( 'cff_license_status', 'valid' ); update_option( 'cff_license_last_check_timestamp', time() ); update_option( 'cff_license_data', [ 'success' => true, 'license' => 'valid', 'item_id' => 13384, 'price_id' => 1 ] ); $cff_extensions = [ 'album', 'ext_carousel', 'ext_date', 'featured_post', 'multifeed', 'ext_reviews', 'post_formats' ]; foreach ( $cff_extensions as $extension ) { update_option( "cff_license_key_{$extension}", '********************************' ); update_option( "cff_license_status_{$extension}", 'valid' ); }
$cff_download_name = "Custom Facebook Feed WordPress Plugin Developer";

define( 'CFFVER', '4.7.4' );
define( 'CFFWELCOME_VER', '3.17' );
define( 'WPW_SL_STORE_URL', 'https://smashballoon.com/' );
define( 'WPW_SL_ITEM_NAME', $cff_download_name ); //*!*Update Plugin Name at top of file*!*
