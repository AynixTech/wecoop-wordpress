...
class CFF_Admin_Notices
{
	...
	public function remove_admin_notices()
	{
		...
		//Check Dismissed Review Notice
		if (!empty($_GET['cff_ignore_rating_notice_nag'])) {
			$this->cff_review_notice_dismiss_action($_GET['cff_ignore_rating_notice_nag']);
		}

		if (!empty($_GET['cff_dismiss'])) {
			$this->cff_review_notice_dismiss_action(1);
		}
	}
