=== Custom Facebook Feed Pro Developer ===
...
== Changelog ==
= 4.7.4 =
* New: Added support for limiting the number of Event posts displayed.
* New: Users can now choose between displaying Videos or Reels in the Videos feed.
* Fix: Plugin security hardening.
* Fix: Resolved Lightbox not triggering in Event feeds.
* Fix: Likebox now displays correctly on mobile devices.
* Fix: Comments box now appears correctly across all layouts and settings.
* Fix: Manual cache clearing now properly updates in the background.
* Fix: Improved layout for Videos & Albums Masonry feeds.
...
= 4.7.3 =
* Fix: Resolved an issue that caused the Masonry layout to appear broken on the frontend.
