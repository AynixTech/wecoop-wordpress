...
//Only load the Masonry code if there's a masonry feed on the page
  ...
  CffFeed.prototype = {
    ...
    sendNeedsResizingToServer: function() {
      var feed = this;
      let locatorNonce = '';
			if ( typeof jQuery(this.el).attr( 'data-locatornonce' ) !== 'undefined' ) {
				locatorNonce = jQuery(this.el).attr( 'data-locatornonce' );
			}
      ...
      if (feed.needsResizing.length > 0 && feed.settings.resizingEnabled) {
        ...
        let locatorNonce = '';
        if ( typeof jQuery(feed.el).attr( 'data-locatornonce' ) !== 'undefined' ) {
          locatorNonce = jQuery(feed.el).attr( 'data-locatornonce' );
        }
        var submitData = {
    ...
    checkConsent: function() {
      ...
      if (typeof window.WPConsent !== 'undefined') {
        ...
        this.settings.consentGiven = typeof window.BorlabsCookie.Consents !== 'undefined' ? window.BorlabsCookie.Consents.hasConsent('facebook') : window.BorlabsCookie.checkCookieConsent('facebook');
  ...
  var cff_init = window.cff_init = function( $cff ){
	...
	function countVisibleChars(htmlText) {
		let $temp = jQuery("<div>").html(htmlText);
		let text = $temp.text();
		return jQuery.trim(text).length;
	}
    ...
    (function($){
      ...
      //Toggle comments
      jQuery(document).off('click', '#cff .cff-view-comments').on('click', '#cff .cff-view-comments', function(){
        var $self = jQuery(this),
      ...
      $cff_post_selector.each(function(){
        ...
        if(countVisibleChars(full_text) >  text_limit){
            ...
            $self.find('.cff-photo, .cff-album-cover, .cff-event-thumb, .cff-html5-video, .cff-iframe-wrap').each(function(){
              ...
              if( $photo.hasClass('cff-iframe-wrap') ){
               ...
               if( $photo.attr('data-img-src-set') !== undefined ){
                ...
                if( !consentGiven ){
                  lb_href =  $photo.find('img').attr('src');
                }
              ...
              if( $photo.hasClass('cff-html5-video') ){
                ...
                if($photo.hasClass('cff-swf')){
                  ...
                  var videoLink = $photo.find('img').attr('data-cff-video');
                  if( videoLink === undefined || videoLink === '' ){
                    if( $photo.attr('data-cff-video-link')  !== undefined || $photo.attr('data-cff-video-link')  !== '' ){
                      videoLink = 'https://www.facebook.com/v2.3/plugins/video.php?href= '+ $photo.attr('data-cff-video-link');
                    }
                  }
                   if ($photo.attr("data-cff-video-player") === 'facebook') {
                        videoLink = 'https://www.facebook.com/v2.3/plugins/video.php?href= '+ $photo.attr('data-cff-video-link');
                      }
                  cffLightboxTile += 'data-url="'+$photo.find('.cff-html5-play').attr('href')+'" data-video="'+ videoLink
                }

                //Videos only:
              } else if( $photo.hasClass('cff-video') ) {
                cffLightboxTile += 'data-url="https://facebook.com/'+$photo.attr('id')+'" data-video="'+$photo.attr('data-source');

              } else if( $photo.hasClass('cff-iframe-wrap') ) {
                cffLightboxTile += 'data-url="https://facebook.com/'+post_id+'" data-video="';
              } else {
...
// reveal any hidden posts due to difference in desktop vs mobile devices
          ...
          let locatorNonce = '';
          if ( typeof $cff.attr( 'data-locatornonce' ) !== 'undefined' ) {
            locatorNonce = $cff.attr( 'data-locatornonce' );
          }
          ...
          $.each(data.comments.data, function(i, commentItem) {
            ...
            if( cff_post_tags && commentItem.hasOwnProperty('message_tags') ){
              ...
              $.each(commentItem.message_tags, function(i, message_tag) {
                ...
                tag_link = '<a href="https://facebook.com/'+message_tag.id+'" target="_blank" rel="nofollow noopener" style="color:'+cff_meta_link_color+'">'+message_tag.name+'</a>';
        ...
        var onSuccess = function(data) {
          ...
          if( typeof data.comments !== 'undefined' ){
            jQuery.each(data.comments.data, function(i, commentItem) {
              ...
              if(cff_comment_author_info){
                if( typeof commentItem.from.link != 'undefined' ){
                  allComments += '<a href="https://facebook.com/'+commentItem.from.id+'" class="cff-name" target="_blank" rel="nofollow noopener">'+commentItem.from.name+'</a>';
                } else {
              ...
              if(cff_comment_author_info) {
                if (consentGiven) {
                  allComments += '<div class="cff-comment-img cff-comment-reply-img"><a href="https://facebook.com/'+commentItem.from.id+'" target="_blank" rel="nofollow noopener"><img src="'+commentItem.from.picture.data.url+'" class="cff-feed-image" width="20" height="20" alt="Avatar" onerror="this.style.display=\'none\'"></a></div>';
                } else {
                  allComments += '<div class="cff-comment-img cff-comment-reply-img"><a href="https://facebook.com/'+commentItem.from.id+'" target="_blank" rel="nofollow noopener"><span data-src="'+commentItem.from.picture.data.url+'"></span></a></div>';
                }
              }
              allComments += '</div>';
            });
      ...
      var Lightbox = (function() {
        ...
        Lightbox.prototype.enable = function() {
          ...
          $('body').on('click', 'a[data-cff-lightbox], area[data-cff-lightbox]', function(event) {
            window.cffCurrentLightboxPostID = $(event.currentTarget).attr('data-id');
          ...
          if( cff_supports_video() ){
            ...
            if (typeof this.album[this.currentImageIndex].video !== 'undefined'
              ...
              if( this.album[this.currentImageIndex].video.length ){
                $('.cff-lightbox-container iframe').show()
                $('#cff-lightbox-wrapper').addClass('cff-has-video');
                $('.cff-lightbox-container iframe').attr({
          ...
          if( this.album[this.currentImageIndex].showthumbs == 'true' ){
            ...
            if( typeof thumbsArr[thisPostId] !== 'undefined' ){
              ...
              $.each(thumbsArr[thisPostId], function(i, thumb) {
                ...
                if( i > 0 ){
                  cffInsertLightboxImage(lightboxImageOrder, thumb[0], thumb[4], thumb[3], thisPostId, albumsonly, true, thumb[6]);
                }
              });
              ...
              var onSuccess = function(data) {
                ...
                if(albumsonly){
                  ...
                  $.each(data.data, function(i, photoItem) {
                    ...
                    albumThumbs += '<a href="'+cffThumbHref+'" class="cff-lightbox-attachment" data-facebook="https://facebook.com/'+photoItem.id+'" data-caption="'+dataCaption+'" orig-caption="'+origCaption+'" data-cff-lightbox-order="'+lightboxImageOrder+'" data-thumbs="true" data-url="http://facebook.com/'+photoItem.id+'" data-iframe data-video data-type="albumsonly" data-cff-isthumbnail="true"><img src="'+cffThumbImg+'" lbcomments="false" width="'+cffPhotoItemWidth+'" height="'+cffPhotoItemHeight+'" /></a>';

                    thumbsData.push([cffThumbHref, cffPhotoItemWidth, cffPhotoItemHeight, 'https://facebook.com/'+photoItem.id, dataCaption, origCaption, undefined, undefined, cffThumbImg]);

                    //Add all of the thumbs (apart from the first thumb) to the lightbox order
                    if( i > 0 ){
                      cffInsertLightboxImage(lightboxImageOrder, cffThumbHref, dataCaption, 'https://facebook.com/'+photoItem.id, thisPostId, albumsonly, true, cffThumbImg);
                    }
                  ...
                  if (typeof data.attachments !== 'undefined') {
                    ...
                    $.each(data.attachments.data[0].subattachments.data, function(i, subattachment) {
                      ...
                      //Add all of the thumbs (apart from the first thumb) to the lightbox order
                      if( i > 0 ){
                        cffInsertLightboxImage(lightboxImageOrder, subattachment.media.image.src, dataCaption, subattachment.url, thisPostId, albumsonly, true, author_name);
                      }
