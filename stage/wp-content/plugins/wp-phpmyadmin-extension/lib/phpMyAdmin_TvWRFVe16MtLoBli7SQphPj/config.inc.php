...
$i++;
$cfg['Servers'][$i]['host'] 			= 'kf041wabzz.zonekf.mydb-aruba.it';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'z&A1%Dyx|D=vpBG`u_9]lLrk2>\"v^xO*' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_TvWRFVe16MtLoBli7SQphPj/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://www.stage.wecoop.org/wp-admin/?rand=80456971&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://www.stage.wecoop.org/wp-admin/?rand=3513998&pma_logout=1';
